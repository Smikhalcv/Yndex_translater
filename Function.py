...
def del_doc(documents, directories):
    del_doc = str(input('Учажите документ, который нужно удалить - '))
    i = 0
...
def move_doc(directories):
    move_doc = str(input('Укажите номер документа, который хотите переместить - '))
    turget_shelf = str(input('Укажите полку, на которую хотете переместить документ - '))
    i = 0
    a = list(directories.keys())
    b = 'Документа с таким номером нет.'
...
def add_shelf(directories):
    new_shelf = str(input('Введите название новой полки - '))
